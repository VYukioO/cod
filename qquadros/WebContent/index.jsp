                        ...
                        <div class="card-content">
                            <table id="filtro">
                                <form>
                                    <tr>
                                        <td>
                                            <input type="checkbox" class="filled-in" id="teste1" />
                                            <label for="teste1">Preto</label>
                                        </td>
                                        <td>
                                            <input type="checkbox" class="filled-in" id="teste2" />
                                            <label for="teste2">Branco</label>
                                        </td>
                                        <td>
                                            <input type="checkbox" class="filled-in" id="teste3" />
                                            <label for="teste3">Azul</label>
                                        </td>
                                        <td>
                                            <input type="checkbox" class="filled-in" id="teste3" />
                                            <label for="teste3">Verde</label>
                                        </td>
                                        <td>
                                            <input type="checkbox" class="filled-in" id="teste3" />
                                            <label for="teste3">Verde</label>
                                    ...
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <button id="filtrar" class="waves-effect waves-light btn" type="submit">Filtrar</button>
                                        </td>
                                    </tr>
                                </form>
                            </table>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="card">
                            ...
                            <div class="card-content">
                                <span class="card-title activator grey-text text-darken-4">PRODUTO 2<i class="material-icons right">more_vert</i></span>
                                <p>
                                    R$ 432,00
                                    <br/><a href="produto.jsp">Ver Mais +</a>
                                </p>
                            ...
                            <div class="card-reveal">
                                <span class="card-title grey-text text-darken-4">produto 2<i class="material-icons right">close</i></span>
